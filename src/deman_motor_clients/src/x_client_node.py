...
if __name__ == '__main__':
    ...
    client = ModbusTcpClient('192.168.11.3', 502)
    connection = client.connect()
    if (connection):
        rospy.loginfo('Connected to X motor on 192.168.11.3:502')

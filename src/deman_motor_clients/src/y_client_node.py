...
if __name__ == '__main__':
    ...
    if (connection):
        ...
        subPosition = rospy.Subscriber('/y_client/position', Int32, callback=position_callback)
        pubStatus = rospy.Publisher('/y_client/status', String, queue_size=10)
        pubActualPosition = rospy.Publisher('/y_client/actual_position', Int32, queue_size=10)
        rate = rospy.Rate(20)
